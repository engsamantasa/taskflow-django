Este README também está disponível em inglês: [Read in English](README.md)
...
O TaskFlow permite que usuários criem, organizem e acompanhem suas tarefas, garantindo que cada usuário tenha acesso apenas aos seus próprios dados.  
A aplicação prioriza simplicidade, usabilidade e código de fácil manutenção, seguindo boas práticas do Django.

Este projeto foi desenvolvido como parte de um portfólio profissional para demonstrar habilidades em desenvolvimento web utilizando Django.
...
- Controle de status das tarefas:
  ...
  - Em andamento
  - Concluída
- Definição de prazo para tarefas
- Filtro de tarefas por status
- Acesso restrito: cada usuário visualiza e gerencia apenas suas próprias tarefas
